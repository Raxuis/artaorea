    ...
    <>
      ...
      <Container>
        ...
        <div className='flex mt-20'>
          <div className='flex-col gap-2 w-full'>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 items-center gap-5">
              <img src="/assets/works/ceramique/ceramique-result-1.webp" alt="Résultat céramique 1" className="w-full h-52 object-cover" />
              <img src="/assets/works/ceramique/ceramique-result-2.webp" alt="Résultat céramique 2" className="w-full h-52 object-cover" />
              <img src="/assets/works/ceramique/ceramique-result-3.webp" alt="Résultat céramique 3" className="w-full h-52 object-cover" />
              <img src="/assets/works/ceramique/ceramique-result-4.webp" alt="Résultat céramique 4" className="w-full h-52 object-cover" />
            </div>
          </div>
        </div>
        <div className='flex mt-10 gap-4 items-center'>
        ...
        <div className='flex mt-10 gap-4'>
          <div className='flex-col space-y-10 w-full'>
            ...
            <div className="grid grid-cols-3 items-center place-items-center gap-10 workshop-container">
              <img src="/assets/works/workshop/workshop-1.webp" alt="Workshop 1" className="h-full w-[20vh] object-cover workshop-1" />
              <img src="/assets/works/workshop/workshop-2.webp" alt="Workshop 2" className="h-full w-[20vh] object-cover workshop-2" />
              <img src="/assets/works/workshop/workshop-3.webp" alt="Workshop 3" className="h-full w-[20vh] object-cover workshop-3" />
            </div>
        ...
        <div className='grid grid-cols-2 lg:grid-cols-3 gap-x-5 gap-y-10 place-items-center'>
          <img src="/assets/works/exploration/exploration-1.webp" alt="Exploration 1" className='size-full lg:w-[17vw] lg:h-[30vh] object-cover' />
          <img src="/assets/works/exploration/exploration-2.webp" alt="Exploration 2" className='size-full lg:w-[17vw] lg:h-[30vh] object-cover' />
          <img src="/assets/works/exploration/exploration-3.webp" alt="Exploration 3" className='size-full lg:w-[17vw] lg:h-[30vh] object-cover' />
          <img src="/assets/works/exploration/exploration-4.webp" alt="Exploration 4" className='size-full lg:w-[17vw] lg:h-[30vh] object-cover' />
          <img src="/assets/works/exploration/exploration-5.webp" alt="Exploration 5" className='size-full lg:w-[17vw] lg:h-[30vh] object-cover' />
          <img src="/assets/works/exploration/exploration-6.webp" alt="Exploration 6" className='size-full lg:w-[17vw] lg:h-[30vh] object-cover' />
        </div>
        ...
        <div className='flex flex-col space-y-5 sm:space-y-10 items-center'>
          <div className='grid grid-cols-1 sm:grid-cols-2 max-sm:pt-5 sm:my-10 gap-5 place-items-center colombe-container'>
            <img src="/assets/works/panneau-colombe/panneau-colombe-1.webp" alt="Panneau Colombe 1" className='h-[30vh] w-[40vh] colombe-1' />
            <img src="/assets/works/panneau-colombe/panneau-colombe-2.webp" alt="Panneau Colombe 2" className='h-[30vh] w-[40vh] colombe-2' />
          </div>
          <img src="/assets/works/panneau-colombe/panneau-colombe-3.webp" alt="Panneau Colombe 3" className='px-8 sm:px-10 w-full sm:w-1/2 colombe-3' />
        </div>
        <div className="flex flex-col text-center text-lg font-semibold mt-10 space-y-10">
          ...
          <div className='flex flex-col space-y-5 sm:space-y-10 items-center'>
            <div className='grid grid-cols-1 sm:grid-cols-2  gap-5 place-items-center constellations-container'>
              <img src="/assets/works/constellations/constellations-1.webp" alt="Constellations 1" className='h-[30vh] w-[40vh] constellations-1' />
              <img src="/assets/works/constellations/constellations-2.webp" alt="Constellations 2" className='h-[30vh] w-[40vh] constellations-2' />
            </div>
            <img src="/assets/works/constellations/constellations-3.webp" alt="Constellations 3" className='px-8 sm:px-10 w-full sm:w-1/2 constellations-3' />
          </div>
        </div>
      </Container>
      <Footer />
